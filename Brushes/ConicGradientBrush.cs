...
namespace ProgressCircleGradient.Brushes
{
    public sealed partial class ConicGradientBrush : XamlCompositionBrushBase
    {
        ...
        /// </summary>
        public static Color SampleColorAtPoint(Windows.Foundation.Point point, double centerX, double centerY, float angleOffsetDeg = 0f)
        {
            ...
            // Apply offsets: initial offset + dynamic angle offset
