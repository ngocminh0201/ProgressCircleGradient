...
namespace ProgressCircleGradient.Controls.ProgressCircle
{
    public class ProgressCircleIndeterminate : ProgressCircle
    {
        ...
        private bool TryApplyFrozenConicColors()
        {
            ...
            Color cTop = ConicGradientBrush.SampleColorAtPoint(top, cx, cy, conic.AngleOffsetDeg);
            Color cRight = ConicGradientBrush.SampleColorAtPoint(right, cx, cy, conic.AngleOffsetDeg);
            Color cBottom = ConicGradientBrush.SampleColorAtPoint(bottom, cx, cy, conic.AngleOffsetDeg);
            Color cLeft = ConicGradientBrush.SampleColorAtPoint(left, cx, cy, conic.AngleOffsetDeg);
